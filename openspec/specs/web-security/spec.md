# Spec: Web — SQL Injection Prevention in PostgREST Data Access

> Source: C1-SQL-Injection (archived 2026-05-11)
> This spec defines security requirements for safe user input handling in PostgREST `.or()` filter strings.
