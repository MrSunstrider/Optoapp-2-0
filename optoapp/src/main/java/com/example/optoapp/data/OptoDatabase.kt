...
@Database(
    entities = [
        ...
        ServicioExtraItem::class,
        RegaloServicioExtraEntity::class,
        CostoProductoEntity::class,
        CostoBiseladoEntity::class,
        CostoLcEntity::class,
        OpticaSettingsEntity::class,
        SyncTelemetryLogEntity::class,
    ],
    version = 54,
    exportSchema = true,
)
...
abstract class OptoDatabase : RoomDatabase() {
    ...
    abstract fun servicioExtraItemDao(): ServicioExtraItemDao
    abstract fun regaloServicioExtraDao(): RegaloServicioExtraDao
    ...
    abstract fun opticaSettingsDao(): OpticaSettingsDao
    abstract fun syncTelemetryLogDao(): SyncTelemetryLogDao
    ...
    companion object {
        ...
        val MIGRATION_41_42 get() = com.example.optoapp.data.MIGRATION_41_42
        val MIGRATION_42_43 get() = com.example.optoapp.data.MIGRATION_42_43
        val MIGRATION_43_44 get() = com.example.optoapp.data.MIGRATION_43_44
        val MIGRATION_44_45 get() = com.example.optoapp.data.MIGRATION_44_45
        val MIGRATION_45_46 get() = com.example.optoapp.data.MIGRATION_45_46
        val MIGRATION_46_47 get() = com.example.optoapp.data.MIGRATION_46_47
        val MIGRATION_47_48 get() = com.example.optoapp.data.MIGRATION_47_48
        val MIGRATION_48_49 get() = com.example.optoapp.data.MIGRATION_48_49
        val MIGRATION_49_50 get() = com.example.optoapp.data.MIGRATION_49_50
        val MIGRATION_50_51 get() = com.example.optoapp.data.MIGRATION_50_51
        val MIGRATION_51_52 get() = com.example.optoapp.data.MIGRATION_51_52
        val MIGRATION_52_53 get() = com.example.optoapp.data.MIGRATION_52_53
        val MIGRATION_53_54 get() = com.example.optoapp.data.MIGRATION_53_54

        fun getDatabase(context: Context): OptoDatabase = INSTANCE ?: synchronized(this) {
