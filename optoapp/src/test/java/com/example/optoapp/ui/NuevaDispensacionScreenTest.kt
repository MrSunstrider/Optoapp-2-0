...
class NuevaDispensacionScreenTest {
    ...
    fun uiState_defaultValuesAreCorrect() {
        ...
        assertEquals("", state.tipoLente)
        assertEquals("", state.distanciaLente)
        assertEquals("", state.altura)
        assertEquals("", state.materialLente)
        assertEquals(emptyList<String>(), state.tratamientos)
        assertEquals("", state.colorLente)
        assertEquals("", state.notasDiseno)
    ...
    fun uiState_allFieldsAreDeclared() {
        ...
        assertTrue(fields.contains("tipoLente"))
        assertTrue(fields.contains("altura"))
        assertTrue(fields.contains("materialLente"))
