...
class MonturaInventoryCoordinatorSyncStockTest {
    ...
    fun syncStockFromMovimientos_rebuildsCorrectStock() = runBlocking {
        ...
        movimientoDao.insertMovimiento(
            MonturaMovimiento(id = "mov1", monturaId = "m1", tipo = "ENTRADA",
                cantidad = 10, stockPrevio = 0, stockNuevo = 10, opticaId = "o1",
                fecha = LocalDate.of(2026, 6, 1))
        )
        movimientoDao.insertMovimiento(
            MonturaMovimiento(id = "mov2", monturaId = "m1", tipo = "SALIDA_VENTA",
                cantidad = 3, stockPrevio = 10, stockNuevo = 7, opticaId = "o1",
                fecha = LocalDate.of(2026, 6, 10))
        )
        movimientoDao.insertMovimiento(
            MonturaMovimiento(id = "mov3", monturaId = "m2", tipo = "ENTRADA",
                cantidad = 5, stockPrevio = 0, stockNuevo = 5, opticaId = "o1",
    ...
    fun syncStockFromMovimientos_respectsOpticaId() = runBlocking {
        ...
        movimientoDao.insertMovimiento(
            MonturaMovimiento(id = "mov1", monturaId = "m1", tipo = "ENTRADA",
                cantidad = 5, stockPrevio = 0, stockNuevo = 5, opticaId = "o2",
                fecha = LocalDate.of(2026, 6, 1))
        )
