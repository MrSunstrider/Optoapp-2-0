-- Fix C-4 (GGA): recalcular_resumen_diario SECURITY DEFINER without membership check
-- Adds app_private.is_optica_member guard after BEGIN to prevent cross-tenant writes,
-- consistent with rpc_deudores and rpc_analisis_mensual pattern
