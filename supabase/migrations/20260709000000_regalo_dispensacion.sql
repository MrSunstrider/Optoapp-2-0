CREATE TABLE public.regalos_dispensacion (
    ...
    motivo TEXT DEFAULT '',
    optica_id UUID NOT NULL REFERENCES public.opticas(id)
);
...
CREATE POLICY "optica regalos" ON public.regalos_dispensacion FOR ALL USING (optica_id = current_setting('app.current_optica_id')::uuid);
