...
public final class OptoDatabase_Impl extends OptoDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '053dc1622e172853385a490e18c53194')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsEvaluaciones = new HashMap<String, TableInfo.Column>(70);
        ...
        final HashMap<String, TableInfo.Column> _columnsDispensaciones = new HashMap<String, TableInfo.Column>(18);
    ...
    }, "053dc1622e172853385a490e18c53194", "b01914733f8260cd3fcb2fa7965e1eeb");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "pacientes","evaluaciones","dispensaciones","pagos");
  }
