...
- `23:15` · `(sin commit)`  
  ...
  - **Estabilidad Android**: Corrección de errores de compilación KSP por imports faltantes en `FullSyncStrategy` y `SyncViewModel`, y solución a referencias no resueltas de Supabase Realtime mediante la adición de la dependencia `realtime-kt` y ajuste del SDK.
